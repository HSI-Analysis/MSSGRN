...
def main():
    ...
    ## network setting
    parser.add_argument('--network', type=str, default='segrn',     #default='sgrhsi', error does not exist
    ...
    parser.add_argument('--input_mode', type=str, default='whole', # part == > error
    ...
    All_data,labeled_data,rows_num,categories,r,c,FLAG, gt_test = a.load_data(flag=args.dataset, trained_on = args.trained_on, number = args.number)
